...
from constant import VAL_RATE, TEST_RATE, WIKI_TS, WIKI_EO_TS
...
PATH = os.path.join(DATA_DIR_PATH, 'wiki_eo')
FILE_NAME = 'wiki_eo.mat'
...
def preprocess_data():
    data = np.loadtxt(os.path.join(PATH, 'wiki_eo.tsv'), delimiter=' ', skiprows=1)
